...
from tests.home.test_forget_password import ForgetPassword
...
suites = [unittest.defaultTestLoader.loadTestsFromName(ForgetPassword) for test_file in module_strings]
